			...
			<div class="container">
				<div class="row text-center fh5co-heading row-padded">
					<div class="col-md-8 col-md-offset-2 to-animate">
						<h2 class="heading">请选择您的送餐地址</h2>
						<p class="sub-heading">温馨提示：如果您的地址信息列表为空，说明您还未添加您的送餐地址，请先在信息管理中添加您的送餐地址。</p>
					</div>
				</div>
				<div class="row">
					<c:forEach items="${address}" var="ad">
						<div class="col-sm-4">
							<div class="fh5co-event to-animate-2">
								...
								<p>${ad.all_location}</p>
								<p>
									<a href="selOrder.do?id=${ad.id}" class="btn btn-primary btn-outline">选择</a>
								</p>
							</div>
						</div>
					</c:forEach>
