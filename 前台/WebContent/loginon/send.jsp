...
<body>
	...
	<div id="fh5co-container">
		...
		<!-- 成功信息 -->
		<div id="fh5co-type" style="background-image: url(foodee/images/slide_3.jpg);" data-stellar-background-ratio="0.5">
			<div class="fh5co-overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-6 to-animate">
						<div class="fh5co-type">
							<h3 class="with-icon icon-2">发送成功</h3>
							<p>感谢您为我们餐厅提出的宝贵意见，您的邮件将会在三到五个工作日之内回复，请耐心等候。</p>
							<p>
								<a href="selEmail.do" class="btn btn-primary btn-outline">查看我的邮件</a>
							</p>
						</div>
					</div>
				</div>
