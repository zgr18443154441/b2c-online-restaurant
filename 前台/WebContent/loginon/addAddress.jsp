			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 to-animate-2">
						<h3>添加新地址</h3>
						<form action="addAddress.do" method="post" enctype="multipart/form-data" onsubmit="return test();">
						<input type="hidden" name="user_id" value="${sessionScope.id}">
							<div class="form-group">
								<input name="realname" class="form-control" placeholder="姓名" type="text" 
									<c:if test="${sessionScope.real_name!=''}">value="${sessionScope.real_name}"</c:if> 
									<c:if test="${sessionScope.real_name==''}">value="${sessionScope.username}"</c:if> 
								>
							</div>
							<div class="form-group">
								称呼&nbsp;&nbsp;
							...
							<div class="form-group">
								<input id="phonenumber" name="phonenumber" class="form-control" placeholder="联系电话" type="text" onkeyup="phonenumberError();">
								<font id="phonenumberError" color="red" size="3"></font>
							</div>
							<div class="form-group">
								<font color="gray" size="2">(*如果在列表中未找到您所在的城市，很抱歉我们的服务还未拓展至您所在的城市)</font>
