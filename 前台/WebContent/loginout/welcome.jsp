				...
				<div class="fh5co-text">
					<div class="container">
						<div class="row">
							...
							<h2 class="to-animate">用心做美食 <span>by</span> <a href="selIntroduceGoods.do" target="_self">府邸美食</a></h2>
						</div>
					</div>
				</div>
			  	<ul class="slides">
			   	<li style="background-image: url(foodee/images/slide_1.jpg);" data-stellar-background-ratio="0.5"></li>
			   	<li style="background-image: url(foodee/images/slide_2.jpg);" data-stellar-background-ratio="0.5"></li>
			   	<li style="background-image: url(foodee/images/slide_3.jpg);" data-stellar-background-ratio="0.5"></li>
			  	</ul>
			</div>
		</div>
	</div>
