			...
			<div class="container">
				<div class="row text-center fh5co-heading row-padded">
					<div class="col-md-8 col-md-offset-2 to-animate">
						<h2 class="heading">精美活动，超值优惠</h2>
						<p class="sub-heading">每逢节假日或周年店庆时期都会推出优惠活动，敬请关注</p>
					</div>
				</div>
				<div class="row">
					<c:forEach items="${activity_list}" var="al">
						<div class="col-sm-4">
							<div class="fh5co-event to-animate-2">
								<h3>${al.name}</font></h3>
								<span class="fh5co-event-meta">${al.start_time}-${al.end_time}</span>
								<p>${al.description}</p>
								<img src="<%=MyConstant.BACK_PATH %>${al.photo}" width="250">
							</div>
						</div>
					</c:forEach>
				</div>
