...
function test(){
	...
	if($fieldset.prop("disabled")==false){
		...
		var url = "testOldPassword.do";
		var id = ${id};
		var param = {id:id,oldpassword:$oldpassword.val()};
		$.post(url,param,function(message){
			if(m=="2"){
				var $fontObj = $("#oldpasswordError");
				$fontObj.html("原密码输入有误");
				var $divObj = $("#op");
				$divObj.attr("class","form-group has-error");
				return false;
			}
...
$(function(){
	$(":radio[name='sex']").val(["<%=request.getAttribute("sex")%>"]);
	$(":radio[name='power']").val(["<%=request.getAttribute("power")%>"]);
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="updateEmployee.do" method="post" enctype="multipart/form-data" onsubmit="return test();">
                                    <div class="form-group">
                                            <label>请先选择员工权限</label>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="power" value="2" onclick="disable();">普通员工
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                        ...
                                        <input type="hidden" name="id" value="${em.id}"/>
                                         <fieldset id="manager" >
                                            <div id="un" class="form-group">
                                                ...
                                                <input class="form-control" id="username" name="username" type="text" value="${em.username}"  placeholder="管理员选项" onkeyup="usernameError();">
                                                <p class="help-block" id="usernameError"></p>
                                                <font color="red">${error}</font>
                                            </div>
                                            <div id="op" class="form-group">
                                                <label for="disabledSelect">原密码</label>
                                                <input class="form-control" id="oldpassword" name="oldpassword" type="password" placeholder="管理员选项" onkeyup="oldpasswordError();">
                                                <p class="help-block" id="oldpasswordError"></p>
                                            </div>
                                            ...
                                            <div id="rw" class="form-group">
                                                <label for="disabledSelect">确认新密码</label>
                                        ...
                                        <div id="rn" class="form-group">
                                             <label for="disabledSelect">姓名</label>
                                                <input class="form-control" id="real_name" name="real_name" type="text" value="${em.name}" onkeyup="realnameError();">
                                        ...
                                        <div id="bd" class="form-group">
                                            <label>出生年月</label>
                                            <input class="form-control" id="birthday" name="birthday" value="${em.birthday}" placeholder="请输入格式为“2000-01-01”格式的日期">
                                            <p class="help-block">提示信息</p>
                                        </div>
                                        <div class="form-group">
                                            <label>邮箱</label>
                                            <input class="form-control" type="text" name="email" value="${em.email}">
                                        </div>
                                        <div class="form-group">
                                            <label>部门</label>
                                        ...
                                        <div class="form-group">
	                                    <label>照片</label>
	                                    <input type="file" name="photo" onchange="preview(this,'preview','imghead',150,200)" src="upload/${em.photo}">
		                                </div>
