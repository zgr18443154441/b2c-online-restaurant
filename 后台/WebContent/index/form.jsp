    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index/index.jsp">后台界面</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">小吃系列</a>
                                </li>
                                <li>
                                    <a href="morris.html">川菜系列</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>固定控制</label>
                                            <p class="form-control-static">546300158@qq.com</p>
                                        </div>
                                        <div class="form-group">
                                            <label>文件上传</label>
                                            <input type="file" name="fengmian" onchange="preview(this,'preview','imghead',150,200)" src="upload/${fengmian}">
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form role="form">
                                        <fieldset disabled>
                                            <div class="form-group">
                                                <label for="disabledSelect">不能输入</label>
                                                <input class="form-control" id="disabledInput" type="text" placeholder="Disabled input" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label for="disabledSelect">不能选</label>
