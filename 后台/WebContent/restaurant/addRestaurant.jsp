                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="addRestaurant.do" method="post" enctype="multipart/form-data">
                                        <div id="sn" class="form-group">
                                            <label for="disabledSelect">负责人</label>
                                        	<input class="form-control" id="manager" name="manager" type="text" onblur="manager(this);" >
                                            <p class="help-block" id="managerError"></p>
                                        </div>
                                        <div class="form-group">
                                            <label>性别</label>
                                            <label class="radio-inline">
                                                <input type="radio" name="sex" id="man" value="先生" >先生
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="sex" id="woman" value="女士" >女士
                                            </label>
                                        </div>
                                        <div id="sn" class="form-group">
                                            <label for="disabledSelect">联系电话</label>
                                        	<input class="form-control" id="phonenumber" name="phonenumber" type="text" onblur="phonenumberError(this);" >
