...
function test(){
	...
	if($discountTxt.val()>1||$discountTxt.val()<0){
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="updateGoods.do" method="post" enctype="multipart/form-data" onsubmit="return test();">
                                    	<input type="hidden" value="${goods.id}" name="id">
                                        <div id="gn" class="form-group">
                                             <label for="disabledSelect">名称</label>
                                                <input class="form-control" id="goods_name" name="goods_name" type="text" value="${goods.goods_name}" onkeyup="goodsnameError();">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="first_class" onchange="changeSecondClass(this);">
                                            	...
                                            	<c:forEach items="${firstName}" var="fn">
                                            		<option value="${fn.id}" <c:if test="${goods.first_id==fn.id}">selected="selected"</c:if>>${fn.kind}</option>
                                            	</c:forEach>
                                            </select>
                                        </div>
                                        ...
                                        <div id="pp" class="form-group">
                                             <label for="disabledSelect">单价（元）</label>
                                                <input class="form-control" id="post_price" name="post_price" type="text" value="${goods.post_price}" onkeyup="postpriceError();">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="piece">
                                            	<c:forEach items="${piece}" var="p">
                                                	<option value="${p.id}" <c:if test="${goods.piece_id==p.id}">selected="selected"</c:if>>${p.piece_name}</option>
                                            	</c:forEach>
                                            </select>
                                        </div>
                                        <div id="dis" class="form-group">
                                            <label for="disabledSelect">折扣</label>
                                            <input class="form-control" id="discount" name="discount" type="text" value="${goods.discount}" placeholder="只能填入0-1之间的小数"/>
                                        	<p class="help-block" id="discountError"></p>
                                        </div>
                                        <div class="form-group">
	                                    <label>照片</label>
	                                    <input type="file" name="photo" onchange="preview(this,'preview','imghead',150,200)" src="upload/${goods.photo}">
		                                </div>
